...
- An optional MechJeb mission addon creates a separate sandbox and attempts a recorded stock Kerbal X flight to Minmus. See [mission operation and qualification](docs/minmus-mission.md). One rendered attempt achieved an intact, settled Minmus touchdown; descent rotation and apparently tipped final posture remain unresolved.
