...
with ZipFile(output, 'w', ZIP_DEFLATED) as archive:
    ...
    for name in ('experiment.md', 'replacement.md', 'validation.md', 'compatibility.md', 'input-timeline.md', 'integration-map.md', 'minmus-mission.md',
                 ...
                 'shadow-worker.md', 'field-gravity.md', 'field-trajectory.md', 'modal-reduction.md', 'interaction-regimes.md', 'encounter-scheduler.md', 'force-observation.md', 'qualification-report.md', 'learned-compute.md', 'aerodynamics.md', 'aero-behavior.md'):
