...
The [direct trajectory and smooth potential-split experiment](field-trajectory.md) tests conservation, step refinement and the product-rule terms needed for a continuous analytic decomposition. It leaves this mesh correction unchanged and does not qualify FFT trajectories.
