...
| Engine data and computation | Stable identities, engine-owned data, KSP reconciliation, query-selected SoA, CPU cache/SIMD/parallelism, GPU residency, contextual strategy selection. [Replacement](replacement.md), [views](execution-views.md); E0D-1873. SIMD code generation and an integrated scheduler remain unproved. |
